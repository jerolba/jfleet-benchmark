...
/*
 * Persist all information in PostgreSQL using PgCopyBulkInsert implementation.
 */
public class CopyDataInsert {
    ...
    public static void main(String[] args) throws IOException, SQLException {
        ...
        try (Connection connection = connectionSuplier.get()) {
            ...
            cfg.batchSize(size);
            BulkInsert<TripEntity> bulkInsert = new PgCopyBulkInsert<>(cfg);

            BenchmarkMeter meter = new BenchmarkMeter(CopyDataInsert.class, properties, size);
            meter.meter(() -> {
